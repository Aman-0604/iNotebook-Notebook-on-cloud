            ...
            <div className="container my-5">
                ...
                <form style={{ width: "90%" }}>
                    <div className="mb-3">
                        ...
                        <input type="text" onChange={onChange} className="form-control" id="title" name='title' value={note.title} aria-describedby="emailHelp" />
                    </div>
                    <div className="mb-3">
                        <label htmlFor="description" className="form-label"><h5>Description</h5></label>
                        <input type="text" onChange={onChange} className="form-control" id="description" value={note.description} name='description' />
                    </div>
                    <div className="mb-3">
